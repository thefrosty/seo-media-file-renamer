...
function seo_media_file_renamer_fields_to_edit( $form_fields, $post ) {
    ...
    $form_fields['seo_media_file_renamer_input'] = array(
   		...
   		'value' => '',
		'helps' => sprintf( __( 'Enter a new file name in the field above. (current filename is <strong>%1$s</strong>)', 'seo-media-file-renamer'), $orig_filename )
	);
